...
export const Dropdown = ({ title, subtitle, detailTitle, detailSubtitle, children, icon }) => {
        ...
        <details className="rounded-md bg-white appearance-none min-w-[512px] max-w-[512px]">
            ...
            <article className="p-4">
                <div className="flex flex-col pt-4 gap-4 border-t-2">
                    <div className="text-light text-gray-400 font-bold">
                        <strong className="font-bold text-2xl text-gray-900">{detailTitle}</strong> <br />
                        {detailSubtitle}
                    </div>
                    {children}
                </div>
...
const ChevronDown = () => <svg width="28" height="28" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const ChevronUp = () => <svg width="28" height="28" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
Dropdown.propTypes = {
    ...
    detailSubtitle: PropTypes.string,
